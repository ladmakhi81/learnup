...
const docTemplate = `{
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/github_com_ladmakhi81_learnup_internals_comment_dto_res.CreateCommentRes"
                                        }
                                    }
                                }
                            ]
    ...
    "definitions": {
        ...
        "github_com_ladmakhi81_learnup_internals_comment_dto_res.CreateCommentRes": {
            "type": "object",
            "properties": {
                "content": {
                    "type": "string"
