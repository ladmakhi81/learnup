...
import "github.com/ladmakhi81/learnup/internals/course/entity"
...
type CreateCourseReq struct {
	...
	Level                       entity.CourseLevel             `json:"courseLevel" validate:"required,oneof=beginner pre-intermediate intermediate advance"`
	Tags                        []string                       `json:"tags,omitempty"`
	AbilityToAddComment         bool                           `json:"abilityToAddComment" validate:"required"`
	CommentAccessMode           entity.CourseCommentAccessMode `json:"commentAccessMode,omitempty" validate:"oneof=all students"`
	Fee                         float64                        `json:"fee" validate:"required,numeric,gte=0"`
