...
type CreateCourseRes struct {
	...
	Level                       entity.CourseLevel             `json:"level"`
	Status                      entity.CourseStatus            `json:"courseStatus"`
	Tags                        []string                       `json:"tags"`
	AbilityToAddComment         bool                           `json:"abilityToAddComment"`
	CommentAccessMode           entity.CourseCommentAccessMode `json:"commentAccessMode"`
